...
**Link:** [https://leetcode.com/problems/number-of-digit-one/](https://leetcode.com/problems/number-of-digit-one/)

## Problem Statement

Solve the 'Number of Digit One' problem using math techniques.
