...
**Link:** [https://leetcode.com/problems/validate-ip-address/](https://leetcode.com/problems/validate-ip-address/)

## Problem Statement

Solve the 'Validate IP Address' problem using other techniques.
