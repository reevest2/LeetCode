...
**Link:** [https://leetcode.com/problems/minimum-height-trees/](https://leetcode.com/problems/minimum-height-trees/)

## Problem Statement

Solve the 'Minimum Height Trees' problem using tree techniques.
