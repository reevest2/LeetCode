...
**Link:** [https://leetcode.com/problems/integer-replacement/](https://leetcode.com/problems/integer-replacement/)

## Problem Statement

Solve the 'Integer Replacement' problem using math techniques.
