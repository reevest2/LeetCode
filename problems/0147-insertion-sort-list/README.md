...
**Link:** [https://leetcode.com/problems/insertion-sort-list/](https://leetcode.com/problems/insertion-sort-list/)

## Problem Statement

Solve the 'Insertion Sort List' problem using sorting techniques.
