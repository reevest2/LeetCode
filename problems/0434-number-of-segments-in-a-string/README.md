...
**Difficulty:** Easy | **Category:** String, Math  
**Link:** [https://leetcode.com/problems/number-of-segments-in-a-string/](https://leetcode.com/problems/number-of-segments-in-a-string/)

## Problem Statement

Solve the 'Number of Segments in a String' problem using string techniques.
