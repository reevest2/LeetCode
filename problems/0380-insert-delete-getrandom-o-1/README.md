...
**Link:** [https://leetcode.com/problems/insert-delete-getrandom-o1/](https://leetcode.com/problems/insert-delete-getrandom-o1/)

## Problem Statement

Solve the 'Insert Delete GetRandom O(1)' problem using other techniques.
