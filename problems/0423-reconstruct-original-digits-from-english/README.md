...
**Link:** [https://leetcode.com/problems/reconstruct-original-digits-from-english/](https://leetcode.com/problems/reconstruct-original-digits-from-english/)

## Problem Statement

Solve the 'Reconstruct Original Digits from English' problem using math techniques.

## Key Insight

Identify the core math pattern and apply it efficiently. Consider edge cases and optimize from brute force.
...
Apply math technique for optimal solution.
