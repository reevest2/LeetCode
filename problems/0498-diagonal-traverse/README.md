...
**Link:** [https://leetcode.com/problems/diagonal-traverse/](https://leetcode.com/problems/diagonal-traverse/)

## Problem Statement

Solve the 'Diagonal Traverse' problem using other techniques.
