...
**Link:** [https://leetcode.com/problems/shortest-palindrome/](https://leetcode.com/problems/shortest-palindrome/)

## Problem Statement

Solve the 'Shortest Palindrome' problem using string techniques.
