...
**Link:** [https://leetcode.com/problems/battleships-in-a-board/](https://leetcode.com/problems/battleships-in-a-board/)

## Problem Statement

Solve the 'Battleships in a Board' problem using other techniques.
