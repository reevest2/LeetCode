...
**Link:** [https://leetcode.com/problems/count-the-repetitions/](https://leetcode.com/problems/count-the-repetitions/)

## Problem Statement

Solve the 'Count The Repetitions' problem using other techniques.
