...
**Link:** [https://leetcode.com/problems/remove-duplicate-letters/](https://leetcode.com/problems/remove-duplicate-letters/)

## Problem Statement

Solve the 'Remove Duplicate Letters' problem using array techniques.
