...
**Link:** [https://leetcode.com/problems/convert-a-number-to-hexadecimal/](https://leetcode.com/problems/convert-a-number-to-hexadecimal/)

## Problem Statement

Solve the 'Convert a Number to Hexadecimal' problem using math techniques.
