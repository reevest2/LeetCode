...
**Difficulty:** Hard | **Category:** Sliding Window, Heap  
**Link:** [https://leetcode.com/problems/sliding-window-median/](https://leetcode.com/problems/sliding-window-median/)

## Problem Statement

Solve the 'Sliding Window Median' problem using sliding window techniques.
