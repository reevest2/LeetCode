...
**Link:** [https://leetcode.com/problems/valid-perfect-square/](https://leetcode.com/problems/valid-perfect-square/)

## Problem Statement

Solve the 'Valid Perfect Square' problem using other techniques.
