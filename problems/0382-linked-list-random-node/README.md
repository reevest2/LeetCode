...
**Link:** [https://leetcode.com/problems/linked-list-random-node/](https://leetcode.com/problems/linked-list-random-node/)

## Problem Statement

Solve the 'Linked List Random Node' problem using linked list techniques.
