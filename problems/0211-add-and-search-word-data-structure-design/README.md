...
**Difficulty:** Medium | **Category:** String, Binary Search, Design  
**Link:** [https://leetcode.com/problems/add-and-search-word---data-structure-design/](https://leetcode.com/problems/add-and-search-word---data-structure-design/)

## Problem Statement

Solve the 'Add and Search Word - Data structure design' problem using string techniques.
