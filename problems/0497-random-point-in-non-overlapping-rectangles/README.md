...
**Link:** [https://leetcode.com/problems/random-point-in-non-overlapping-rectangles/](https://leetcode.com/problems/random-point-in-non-overlapping-rectangles/)

## Problem Statement

Solve the 'Random Point in Non-overlapping Rectangles' problem using other techniques.

## Key Insight

Identify the core other pattern and apply it efficiently. Consider edge cases and optimize from brute force.
...
Apply other technique for optimal solution.
