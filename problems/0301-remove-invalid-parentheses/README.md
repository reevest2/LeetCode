...
**Difficulty:** Hard | **Category:** Stack/Queue  
**Link:** [https://leetcode.com/problems/remove-invalid-parentheses/](https://leetcode.com/problems/remove-invalid-parentheses/)

## Problem Statement

Solve the 'Remove Invalid Parentheses' problem using stack/queue techniques.
