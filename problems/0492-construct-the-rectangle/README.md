...
**Link:** [https://leetcode.com/problems/construct-the-rectangle/](https://leetcode.com/problems/construct-the-rectangle/)

## Problem Statement

Solve the 'Construct the Rectangle' problem using other techniques.
