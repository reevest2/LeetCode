...
**Link:** [https://leetcode.com/problems/strong-password-checker/](https://leetcode.com/problems/strong-password-checker/)

## Problem Statement

Solve the 'Strong Password Checker' problem using string techniques.
