...
**Link:** [https://leetcode.com/problems/create-maximum-number/](https://leetcode.com/problems/create-maximum-number/)

## Problem Statement

Solve the 'Create Maximum Number' problem using math techniques.
