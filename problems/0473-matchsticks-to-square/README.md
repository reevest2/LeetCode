...
**Link:** [https://leetcode.com/problems/matchsticks-to-square/](https://leetcode.com/problems/matchsticks-to-square/)

## Problem Statement

Solve the 'Matchsticks to Square' problem using other techniques.
